...
function Socials() {
  return (
    <Div>
      ...
      <Link href='https://wa.me/6285215517605' target='_blank'>
        <Svg>
          <use href={whatsappIcon + '#whatsapp'}></use>
        </Svg>
      </Link>

      <Link href='https://t.me/VEmpink' target='_blank'>
        <Svg>
          <use href={telegramIcon + '#telegram'}></use>
        </Svg>
      </Link>

      <Link href='https://github.com/VEmpink' target='_blank'>
        <Svg>
      ...
      <Link href='https://www.linkedin.com/in/VEmpink' target='_blank'>
        <Svg>
          <use href={linkedinIcon + '#linkedin'}></use>
        </Svg>
      </Link>

      <Link href='https://fb.me/VEmpink' target='_blank'>
        <Svg>
